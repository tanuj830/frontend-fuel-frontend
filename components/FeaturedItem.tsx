...
<div className='pr-3'>
      ...
      <div className="scale-90 rounded-md space-y-2 pb-2 lg:space-y-4 w-full flex flex-col">
  {/* <div className="text-xs text-zinc-400">Featured</div> */}
  <div className="p-[1px] rounded-xl ">
  <div className="bg-gradient-to-r from-muted to-[rgb(24, 24, 27)] border dark:border-muted to rounded-xl p-2 lg:p-3 flex items-center gap-2 lg:gap-4">
    ...
    <div>
      <p className="text-xs font-semibold">Daily <br /> Level Up</p>
