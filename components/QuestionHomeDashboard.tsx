    ...
    return (
      ...
      >
        <div className='border my-10 w-full h-[70vh] lg:h-[80vh] overflow-y-scroll relative rounded-xl'>
          {/* Top bar */}
          <div className='flex items-center px-2 sticky top-0 py-2 dark:bg-black bg-white z-[200]'>
          ...
          {/* Bottom CTA */}
          <div className='w-full flex sticky bottom-0 justify-center gradient text-primary-foreground'>
            {
              index === 0 ?
