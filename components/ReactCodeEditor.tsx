...
//     if (stored) {
//       const parsed = JSON.parse(stored);
//       return parsed["/src/style.css"].code || `
//       @tailwind base;
// @tailwind components;
// @tailwind utilities;
// .title {
...
//   const [postcssConfigJS, setPostcssConfigJS] = React.useState<string>(() => {
//     const stored = localStorage.getItem("files");
//     if (stored) {
//       const parsed = JSON.parse(stored);
//       return parsed["/postcss.config.js"].code || `module.exports = {
//   plugins: {
//     tailwindcss: {},
//     autoprefixer: {},
//   },
...
//   const [tailwindConfigJS, setTailwindConfigJS] = React.useState<string>(() => {
//     const stored = localStorage.getItem("files");
//     if (stored) {
//       const parsed = JSON.parse(stored);
//       return parsed["/tailwind.config.js"].code || `module.exports = {
//   content: ["./App.js"],
//   theme: {
//     extend: {},
//   },
...
//         "/postcss.config.js": { code: postcssConfigJS },
//         "/tailwind.config.js": { code: tailwindConfigJS },
//       }}
//     >
