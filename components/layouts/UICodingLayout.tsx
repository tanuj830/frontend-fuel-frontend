...
const UICodingLayout = () => {

  const {loading, uiQuestions}:any = useQuestionsByCategories()
  ...
  return (
    <div className='p-6 lg:p-14'>
            <div>
                ...
                <h1 className='text-2xl lg:text-3xl font-bold leading-16'>All UI based questions</h1>
                <span className='leading-1 text-muted-foreground font-semibold text-sm lg:text-md'>The largest question bank of {uiQuestions?.length}+ practice questions for front end interviews
                </span>
            </div>
            ...
            <QuestionsPlayground questions={uiQuestions}/>
            </div>

  )
}

export default UICodingLayout
